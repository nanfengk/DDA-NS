...
%% 数据准备
x = [1 3 5 7 9];    
dataset = [0.9461 0.9504 0.8881 0.8904 0.7773 ;
           0.9575 0.9609 0.8984  0.9079 0.7954 ;
            0.9557 0.9601 0.8991 0.9007 0.7997 ;
            0.9545 0.9600 0.8949 0.8929 0.7918 ;
           0.9533 0.9591 0.8953 0.8919 0.7928 ]'; 
%   'AUC',' ','AUPR',' ','F1',' ','Rec',' ','MCC'},...
...
set(gca, 'Box', 'off', ...                                         
         ...
         'Yticklabel',{num2str([0.74:0.02:1]','%.2f')})
% legend
