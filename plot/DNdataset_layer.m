...
%% 数据准备
x = [1 3 5 7 9];    
dataset = [0.9785 0.9797 0.9345 0.9384 0.8687 ;
           0.9782 0.9794 0.9391  0.9425 0.8781 ;
            0.9731 0.9746 0.927 0.9087 0.8583 ;
            0.9652 0.9684 0.9193 0.9177 0.8401 ;
           0.9624 0.9659 0.9157 0.9166 0.8324 ]'; 
%   'AUC',' ','AUPR',' ','F1',' ','Rec',' ','MCC'},...
