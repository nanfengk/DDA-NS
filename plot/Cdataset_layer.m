...
%% 数据准备
x = [1 3 5 7 9];    
dataset = [0.9487 0.9447 0.8966 0.9107 0.791 ;
           0.9563 0.9527 0.8977  0.9072 0.7952 ;
            0.9514 0.9552 0.8963 0.9210 0.7895 ;
            0.9516 0.9556 0.8962 0.8981 0.7931 ;
           0.9514 0.9571 0.8945 0.9111 0.7866 ]'; 
%   'AUC',' ','AUPR',' ','F1',' ','Rec',' ','MCC'},...
...
set(gca, 'Box', 'off', ...                                         
         ...
         'Yticklabel',{num2str([0.76:0.02:1]','%.2f')})
% legend
